...
beautiful.init("/home/divarvel/.config/awesome/themes/default/theme.lua")
...
tags = {
  names = { "www", "code", "ssh", "social", "email","music", "movies", "gimp" },
...
-- batinfo = awful.widget.textbox({ name = "batinfo", text = "Batterie" })

-- Assign a hook to update info
-- awful.hooks.timer.register(1, function() batinfo.text = "BAT: |" end)
