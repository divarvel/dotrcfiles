...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Volume management
    , ((0                 , xF86AudioLowerVolume), spawn "amixer -q sset Master 2%-")
    , ((0                 , xF86AudioMute), spawn "amixer -q sset Master toggle")
    , ((0                 , xF86AudioRaiseVolume), spawn "amixer -q sset Master 2%+")

    -- MPD signals
    , ((0                 , xF86AudioPlay), spawn "mpc toggle")
    , ((0                 , xF86AudioStop), spawn "mpc stop")
